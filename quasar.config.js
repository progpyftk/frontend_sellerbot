...
module.exports = configure(function (ctx) {
  return {
    ...
    extras: [
      ...
      "mdi-v7", // Adiciona o Material Design Icons v7
      "roboto-font", // opcional
      "material-icons", // opcional, você não está vinculado a ele
    ],
    ...
    devServer: {
      https: false, // 👈 MUDE ISTO PARA FALSE (ou remova a linha)
      port: 9000,
      open: true,
    },
